...
const channels = [
  {
    ...
    colorVar: "var(--cc-success)",
    softVar: "var(--cc-success-soft)",
  ...
  },
  {
    ...
    colorVar: "var(--cc-primary)",
    softVar: "var(--cc-primary-soft)",
    buildUrl: (url: string) =>
  ...
  },
  {
    ...
    colorVar: "var(--cc-info)",
    softVar: "var(--cc-info-soft)",
    buildUrl: (url: string) =>
